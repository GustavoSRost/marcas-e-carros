...
export const ListaCarros = (props) => {
  ...
  return (
    ...
    >
      <ul
        className={`flex flex-col  lg:max-h-[800px] max-w-full overflow-y-auto transition-all appearance-none scrollbar scrollbar-none  scrollbar-w `}
      >
        {carros.map((item) => {
          return (
            <li
            ...
            >
              <a href="/">
                <ul className="p-2 flex flex-col md:flex-row items-start md:items-center gap-2 lg:h-62 ">
                  ...
                  <ul>
                    <li className="">
                      Marca: <span className="font-semibold">{item.marca}</span>
                    </li>
                    <li className="">
                      Modelo:{" "}
